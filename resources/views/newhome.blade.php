...
<head>
    ...
    <!-- Title -->
    <title>Home || qutter || qutter PHP Template</title>
    <!-- Favicon Icon -->
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-xl-2 col-6 col-small">
                        <div class="footer-widget menu-widget wow fadeInUp delay-0-4s">
                            ...
                            <ul>
                                <li><a href="service-details.php">Hair Cutting</a></li>
                                <li><a href="about.php">Shaving & Design</a></li>
                                <li><a href="service-details.php">Hair Colors</a></li>
                                <li><a href="shop.php">Beauty & Spa</a></li>
                                <li><a href="service-details.php">Body Massages</a></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="footer-widget news-widget wow fadeInUp delay-0-6s">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div class="content">
                                        <h6><a href="blog-details.php">Get Started With Node Introduction APIs HTTP And
                                                ES6 JavaScript</a></h6>
                                        <span class="date">
                                ...
                                <li>
                                    ...
                                    <div class="content">
                                        <h6><a href="blog-details.php">Web Standards: The What The Why And The How Learn
                                                CSS</a></h6>
                                        <span class="date">
                                            <i class="far fa-calendar-alt"></i>
                                            25 september 2021
